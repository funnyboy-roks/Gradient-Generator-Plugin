...
/**
 * Class for generating gradients for Spigot
 *
 * I did not make any of the code that does the actual gradient calculations, that's made by <a href="https://github.com/anomal">anomal on GitHub</a>
 *
...
public class GradientGeneration {
    ...
    public static ArrayList<String> createGradient(int count, String[] colours) {
        com.anomal.RainbowVis.Rainbow rainbow = new com.anomal.RainbowVis.Rainbow();

        try {
            rainbow.setNumberRange(1, count);
            rainbow.setSpectrum(colours);
        } catch (com.anomal.RainbowVis.HomogeneousRainbowException | com.anomal.RainbowVis.InvalidColourException | com.anomal.RainbowVis.NumberRangeException ignored) {} catch (Exception e) {
            e.printStackTrace();
        }
